...
class VenuesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create venue" do
    assert_difference('Venue.count') do
      post venues_url, params: { venue: { coordinates: @venue.coordinates, name: @venue.name } }
    end
  ...
  test "should update venue" do
    patch venue_url(@venue), params: { venue: { coordinates: @venue.coordinates, name: @venue.name } }
